...
/**
 * This is the item provider adapter for a {@link org.saferobots.ssml.metamodel.ssml.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SsmlPackage.Literals.CONNECTOR__IN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SsmlPackage.Literals.CONNECTOR__OUT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SsmlPackage.Literals.CONNECTOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SsmlPackage.Literals.CONNECTOR__CONTAINS_SYSTEM);
			childrenFeatures.add(SsmlPackage.Literals.CONNECTOR__HAS_NFP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SsmlPackage.Literals.CONNECTOR__CONTAINS_SYSTEM,
				 SsmlFactory.eINSTANCE.createSystem()));

		newChildDescriptors.add
			(createChildParameter
				(SsmlPackage.Literals.CONNECTOR__HAS_NFP,
				 SsmlFactory.eINSTANCE.createNFP()));
	}
